...
def activity_reports(client_id: int, contract_id: int, wo_id: int):
    ...
    res: requests.Response = requests.get(url=f"{API_URL}/api/v1/clients/{client_id}/contracts/{contract_id}/wo/{wo_id}/ar", headers=headers)
...
def add(client_id: int, contract_id: int, wo_id: int):
    ...
    if request.method == 'POST':
        ...
        res: requests.Response = requests.post(url=f"{API_URL}/api/v1/clients/{client_id}/contracts/{contract_id}/wo/{wo_id}/ar", data=json.dumps(obj=data), headers=headers)
...
def edit(client_id: int, contract_id: int, wo_id: int, ar_id: int):
    ...
    if request.method == 'POST':
        ...
        res: requests.Response = requests.put(url=f"{API_URL}/api/v1/clients/{client_id}/contracts/{contract_id}/wo/{wo_id}/ar/{ar_id}", data=json.dumps(obj=data), headers=headers)
        if res.status_code in (200,201):
    ...
    res: requests.Response = requests.get(url=f"{API_URL}/api/v1/clients/{client_id}/contracts/{contract_id}/wo/{wo_id}/ar/{ar_id}", headers=headers)
    if res.status_code == 200:
